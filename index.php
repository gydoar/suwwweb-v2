<?php include "header.php"; ?>
  ...
  <div class="banner">
    <div class="container">
      <div class="seven columns offset-by-four copy-front">
        <p>PÁGINAS <strong>WEB</strong></p>
        <p>PARA <strong>EMPRESAS</strong></p>
  ...
  <div class="home__paginas__web" id="paginas-web">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="twelve columns tab_content">
          <!-- Tab 1 -->
          <div id="tab1">
  ...
  <div class="tienda__online">
    <div class="container">
      <div class="six columns img__tienda">
        <img width="691px" src="assets/images/tienda-online.png" alt="">
      </div>
      <div class="six columns text__tienda">
        <h2>TIENDA ONLINE</h2>
          ...
          <div id="tab1">
            <div class="four columns offset-by-one">
              ...
              <ul class="planes">
                ...
                <li><p>Llegue a las personas interesadas</p></li>
                <li><p>Anuncie en el mundo</p></li>
              </ul>
 ...
 <!-- IMAGEN CORPORATIVA -->
      ...
      <div class="row">
        ...
        <div class="twelve columns tab_content">
          ...
          <div id="tab1">
            ...
            <div class="seven columns center">
              <img width="500px" src="assets/images/imagen-corporativa.png" alt="">
            </div>
          </div>
  ...
  <!-- Nuestros Proyectos -->
  <div>
    <?php include "parts-body/nuestros-proyectos.php"; ?>
  </div>
  <!-- //Nuestros Proyectos -->
